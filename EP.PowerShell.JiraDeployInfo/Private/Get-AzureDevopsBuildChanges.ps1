function Get-AzureDevopsBuildChanges {
    ...
    Write-Verbose("Build changes (artificatDatda.data)" + $response.fps.dataProviders.data.'ms.vss-traceability-web.traceability-run-changes-data-provider'.artifactsData.data[0])
